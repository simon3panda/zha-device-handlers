...
async def test_Linxura_button_trigger(zigpy_device_from_quirk, quirk):
    ...
    assert listener.zha_send_event.call_args == mock.call(
        ...
        {
            "button": "button_1",
            "press_type": "remote_button_short_press",
            "command_id": 10,
        },
    )
    ...
    assert listener.zha_send_event.call_count == 1
    assert listener.zha_send_event.call_args == mock.call(
        "button_1_remote_button_double_press",
        {
            "button": "button_1",
            "press_type": "remote_button_double_press",
            "command_id": 10,
        },
    )
    ...
    assert listener.zha_send_event.call_args == mock.call(
        ...
        {
            "button": "button_1",
            "press_type": "remote_button_long_press",
            "command_id": 10,
        },
    )
    ...
    assert listener.zha_send_event.call_count == 1
    assert listener.zha_send_event.call_args == mock.call(
        "button_2_remote_button_short_press",
        {
            "button": "button_2",
            "press_type": "remote_button_short_press",
            "command_id": 10,
    ...
    assert listener.zha_send_event.call_count == 1
    assert listener.zha_send_event.call_args == mock.call(
        "button_2_remote_button_double_press",
        {
            "button": "button_2",
            "press_type": "remote_button_double_press",
            "command_id": 10,
    ...
    assert listener.zha_send_event.call_count == 1
    assert listener.zha_send_event.call_args == mock.call(
        "button_2_remote_button_long_press",
        {
            "button": "button_2",
            "press_type": "remote_button_long_press",
            "command_id": 10,
    ...
    assert listener.zha_send_event.call_count == 1
    assert listener.zha_send_event.call_args == mock.call(
        "button_3_remote_button_short_press",
        {
            "button": "button_3",
            "press_type": "remote_button_short_press",
            "command_id": 10,
    ...
    assert listener.zha_send_event.call_count == 1
    assert listener.zha_send_event.call_args == mock.call(
        "button_3_remote_button_double_press",
        {
            "button": "button_3",
            "press_type": "remote_button_double_press",
            "command_id": 10,
    ...
    assert listener.zha_send_event.call_count == 1
    assert listener.zha_send_event.call_args == mock.call(
        "button_4_remote_button_short_press",
        {
            "button": "button_4",
            "press_type": "remote_button_short_press",
            "command_id": 10,
    ...
    assert listener.zha_send_event.call_count == 1
    assert listener.zha_send_event.call_args == mock.call(
        "button_4_remote_button_double_press",
        {
            "button": "button_4",
            "press_type": "remote_button_double_press",
            "command_id": 10,
    ...
    assert listener.zha_send_event.call_count == 1
    assert listener.zha_send_event.call_args == mock.call(
        "button_4_remote_button_long_press",
        {
            "button": "button_4",
            "press_type": "remote_button_long_press",
            "command_id": 10,
